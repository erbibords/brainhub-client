...
export const BASE_URL = 'https://brainhub-service-cjm6z.ondigitalocean.app/v2/';
...
export const OFFERING_BASE_URL = () =>
...
export const PAYMENTS_BASE_URL = () =>
  `branches/${DEFAULT_BRANCH_ID()}/payments`;
export const SCHOOLS_BASE_URL = () => `branches/${DEFAULT_BRANCH_ID()}/schools`;
export const ENROLLMENT_BASE_URL = () =>
